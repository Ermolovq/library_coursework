 ...
 * @author Мой ПК
 */
public class addCustomerWindow extends javax.swing.JFrame {

    /**
     * Creates new form addCustomerWindow
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Додавання клієнта в базу даних");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try(Connection connection = DBConnection.getConnection("bibliaryDB")){
            String query = "INSERT INTO customers(id,name,secondName,phone,email) VALUES(?,?,?,?,?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addCustomerWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
